...
const defaultVolume: Record<string, { mev: number; mav: number; mrv: number }> = {
  Glutes: { mev: 10, mav: 16, mrv: 25 },
  Hamstrings: { mev: 6, mav: 12, mrv: 18 },
  Quadriceps: { mev: 6, mav: 12, mrv: 18 },
  Shoulders: { mev: 2, mav: 6, mrv: 10 },
  Triceps: { mev: 2, mav: 5, mrv: 10 },
  Abdominals: { mev: 0, mav: 6, mrv: 12 },
  Lats: { mev: 6, mav: 12, mrv: 17 },
  Biceps: { mev: 4, mav: 8, mrv: 13 },
  'Upper Back': { mev: 6, mav: 12, mrv: 17 },
  Abductors: { mev: 2, mav: 6, mrv: 12 },
  Chest: { mev: 2, mav: 5, mrv: 10 },
